  ...
  return (
    ...
    >
      ...
      <div className="z-1 text-text-secondary h-fit m-auto">
        ...
        <form className="md:w-xl space-y-4 bg-bg-secondary text-text-primary rounded-b-lg px-4 py-2 md:px-8 md:py-4">
          <label className="text-xl">Full Name</label>
          <input className="focus:outline-none border rounded-md border-border px-4 py-2 w-full" />
          ...
          <p className="text-center text-sm">
            Sign up to also receive weekly fitness updates from me on your
            email.
          </p>
        </form>
      </div>
